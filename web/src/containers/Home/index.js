  ...
  render() {
    return (
      <div style={{ flex: '1' }}>
        ...
        <div style={{ overflow:'auto', width:'500px', height:'350px', backgroundColor: 'white' ,padding: '3rem 4rem', margin: '2rem auto',}}>
          <h3 style={{ marginBottom: '2rem', textAlign: 'center', }}>ROOMS</h3>
          {this.renderRooms()}
        </div>
      </div>
    );
