defmodule Sling.User do
  ...
  # just cd C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC and type vcvarsall.bat amd64
  # and then cd C:\Users\Mathaeus\Documents\Visual Studio Code\sling\api iex -S mix
